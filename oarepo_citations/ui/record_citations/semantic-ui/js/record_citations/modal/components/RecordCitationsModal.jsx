...
export const RecordCitationsModal = ({
  record,
  citationStyles = [
  ...
  return (
    ...
    >
      <Modal.Header as="h1" id="citation-modal-header">
        {i18next.t("Citations")}
      </Modal.Header>
      <Modal.Content>
        <p id="citation-modal-desc">
          {i18next.t("record-citation-modal-description")}
        </p>
        <Segment>
      ...
      <Modal.Actions>
        <Button
          title={i18next.t("Close citations modal window")}
